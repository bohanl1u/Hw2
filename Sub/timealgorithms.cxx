...
int main(int argc, char** argv) {
    ...
    for (auto itr = jsonObject.begin(); itr != jsonObject.end(); ++itr){
        ...
        if (key=="metadata"){
            ...
            vector<int> tempVec2 = tempVec;
            start = chrono::high_resolution_clock::now();
            InsertionSort(&tempVec2, ICompares, IMemAccesses);
            ...
            tempVec2 = tempVec;
            start = chrono::high_resolution_clock::now();
            MergeSort(&tempVec2, MCompares, MMemAccesses);
            ...
            tempVec2 = tempVec;
            start = chrono::high_resolution_clock::now();
            QuickSort(&tempVec2, QCompares, QMemAccesses);
            end = chrono::high_resolution_clock::now();
            elapsed = chrono::duration<double, micro>(end - start).count();
            csv += to_string(elapsed) + ",";
